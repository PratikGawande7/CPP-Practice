...
// for (initialization; condition ;updation ){
 ...
 //(3) then code inside the scope startb to run 
 //(4) then again value of i is updated i=i+1
//(5) then again it is check whether condition still fulfill or not that is i becomes 2 then it is check whether conditionm is still true or not 2<=5 true so again code inside scope start to run
...
// in the above example we took the condition as i<=60 instead of this condition we could have use i<70
